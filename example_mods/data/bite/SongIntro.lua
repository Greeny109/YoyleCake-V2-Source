...
function onCreate()
	...
	makeGraphic('JukeBox', 300, 120, '000000')
	...
	makeLuaText('JukeBoxSubText', 'Bite', 300, -305-IntroTagWidth, 60+70)
	...
	makeLuaText('JukeBoxCommersText', 'Remix By: DangerBites', 300, -305-IntroTagWidth, 90+90)
