...
IntroTagColor = '54EBFF'	--Color of the tag at the end of the box.
...
function onCreate()
	...
	makeLuaText('JukeBoxSubText', 'Bowling With Explosions', 300, -305-IntroTagWidth, 60+70)
	setTextAlignment('JukeBoxSubText', 'left')
	setObjectCamera('JukeBoxSubText', 'other')
	setTextSize('JukeBoxSubText', IntroSubTextSize)
	addLuaText('JukeBoxSubText')

	makeLuaText('JukeBoxComText', 'Composed By: TheGabiM', 300, -305-IntroTagWidth, 115+70)
