...
function onCreate()
	...
	makeLuaText('JukeBoxSubText', 'Equations', 300, -305-IntroTagWidth, 60+70)
	setTextAlignment('JukeBoxSubText', 'left')
	setObjectCamera('JukeBoxSubText', 'other')
	setTextSize('JukeBoxSubText', IntroSubTextSize)
	addLuaText('JukeBoxSubText')

	makeLuaText('JukeBoxComText', 'Composed By: TheGabiM, srDoret, Caster, CrispyNugget, DangerBites, Greeny109 and LukaSpatula', 300, -305-IntroTagWidth, 90+70)
