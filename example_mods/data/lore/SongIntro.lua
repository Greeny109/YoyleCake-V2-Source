...
IntroComTextSize = 20
IntroCommersTextSize = 20 --size of the text for the Composed by.
IntroTagColor = 'd7fc03'--Color of the tag at the end of the box.
...
function onCreate()
	...
	makeLuaText('JukeBoxSubText', 'Lore', 300, -305-IntroTagWidth, 60+70)
	setTextAlignment('JukeBoxSubText', 'left')
	setObjectCamera('JukeBoxSubText', 'other')
	setTextSize('JukeBoxSubText', IntroSubTextSize)
	addLuaText('JukeBoxSubText')

	makeLuaText('JukeBoxComText', 'Original By: kiwiquest', 300, -305-IntroTagWidth, 90+70)
	...
	makeLuaText('JukeBoxCommersText', 'Remix By: TheGabiM and EthanAwoke', 300, -305-IntroTagWidth, 90+90)
	setTextAlignment('JukeBoxCommersText', 'left')
	setObjectCamera('JukeBoxCommersText', 'other')
	setTextSize('JukeBoxCommersText', IntroComTextSize)
	addLuaText('JukeBoxCommersText')
end
...
function onSongStart()
	...
	doTweenX('MoveInSix', 'JukeBoxCommersText', 0, 1, 'CircInOut')
...
function onTimerCompleted(tag, loops, loopsLeft)
	...
	if tag == 'JukeBoxWait' then
		...
		doTweenX('MoveOutSix', 'JukeBoxCommersText', -450, 1.5, 'CircInOut')
	end
end