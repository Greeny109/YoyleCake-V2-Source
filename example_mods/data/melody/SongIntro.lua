...
IntroTagColor = '454545'	--Color of the tag at the end of the box.
...
function onCreate()
	...
	makeLuaText('JukeBoxSubText', 'Melody', 300, -305-IntroTagWidth, 50+70)
	setTextAlignment('JukeBoxSubText', 'left')
	setObjectCamera('JukeBoxSubText', 'other')
	setTextSize('JukeBoxSubText', IntroSubTextSize)
	addLuaText('JukeBoxSubText')

	makeLuaText('JukeBoxComText', 'Composed By: Dangerbites and Greeny109', 300, -305-IntroTagWidth, 90+70)
