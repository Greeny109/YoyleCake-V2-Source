...
IntroTagColor = '967300'	--Color of the tag at the end of the box.
...
function onCreate()
	...
	makeLuaText('JukeBoxSubText', 'Only Six', 300, -305-IntroTagWidth, 60+70)
	setTextAlignment('JukeBoxSubText', 'left')
	setObjectCamera('JukeBoxSubText', 'other')
	setTextSize('JukeBoxSubText', IntroSubTextSize)
	addLuaText('JukeBoxSubText')

	makeLuaText('JukeBoxComText', 'Composed By: JustAnotherSaltyGirl (ft: TheGabiM)', 300, -305-IntroTagWidth, 90+70)
