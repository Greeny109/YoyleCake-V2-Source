		...
		switch (FreeplaySelection.freeSelect[FreeplaySelection.curCategory].toLowerCase())
			{
				...
				case 'parodies':
					addWeek(['Washable', 'Beefy-Die', 'Only Six', 'Illegal Immigrant'], 1, 0xffadecff, ['find-marker', 'beefy', 'firey-wihy', 'stop-sign']);
				case 'extra':
					addWeek(['Disturbing-Footage', 'Consumption', 'Plushified', 'Yeah-I-Know', 'Large BBQ', 'Lore', 'Newbie Alliance', 'Puppetry'], 1, 0xffadecff, ['firey-underwear', 'mouth', 'firey-plush', 'duo', 'ruby', 'katyj98', 'gelatinlolli', 'leafy-af']);
			}
